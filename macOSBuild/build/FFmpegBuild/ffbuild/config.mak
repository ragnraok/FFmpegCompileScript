...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-debug --disable-programs --disable-doc --enable-pic --enable-gpl --enable-libx264 --enable-static --disable-ffmpeg --disable-ffplay --disable-programs --disable-ffprobe --disable-avdevice --prefix=/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/macOSBuild/libFFmpeg --arch=x86_64 --extra-cflags=-I/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/macOSBuild/libx264/include --extra-ldflags=-L/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/macOSBuild/libx264/lib
...
CFLAGS=  -I/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/macOSBuild/libx264/include -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread  -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/macOSBuild/libx264/include -fPIC -Qunused-arguments
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/macOSBuild/libx264/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-liconv -lm -llzma -lz -framework AudioToolbox -lx264 -pthread -lm -pthread -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
