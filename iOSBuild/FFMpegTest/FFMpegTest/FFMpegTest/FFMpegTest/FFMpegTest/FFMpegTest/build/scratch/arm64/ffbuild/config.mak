...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --enable-gpl --enable-libx264 --enable-static --disable-ffmpeg --disable-ffplay --disable-programs --disable-ffprobe --disable-avdevice --extra-cflags='-arch arm64 -mios-version-min=10.0 -fembed-bitcode -I/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/iOSBuild/x264-iOS/include' --extra-ldflags='-arch arm64 -mios-version-min=10.0 -fembed-bitcode -L/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/iOSBuild/x264-iOS/lib' --prefix=/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/iOSBuild/build/thin/arm64
prefix=/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/iOSBuild/build/thin/arm64
...
CFLAGS=  -arch arm64 -mios-version-min=10.0 -fembed-bitcode -I/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/iOSBuild/x264-iOS/include -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread  -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch arm64 -mios-version-min=10.0 -fembed-bitcode -I/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/iOSBuild/x264-iOS/include -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mios-version-min=10.0 -fembed-bitcode -L/Volumes/Ragnarok/Personal/Project/FFmpegCompileScript/iOSBuild/x264-iOS/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-liconv -lm -lz -framework AudioToolbox -lx264 -pthread -lm -pthread -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo
