...
extralibs_avcodec="-liconv -lm -lz -framework AudioToolbox -lx264 -pthread -lm -pthread -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo"
